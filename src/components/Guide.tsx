...
export function Guide({ onClose }: { onClose: () => void }) {
  return <Dialog title="导入课表" onClose={onClose} wide>
    ...
    <div className="guide-steps">
      ...
      <div><span className="step-dot"><FileCode2 size={17} /></span><section><h3>Ctrl + S 保存网页</h3><p>选择学年与学期，点击「查询」并切换到「表格」视图。等课程显示完整后按 <strong>Ctrl + S</strong>，保存为「网页，全部」或「网页，仅 HTML」。</p><p>回到课历导入保存的 <code>.html</code> 或 <code>.htm</code> 文件，旁边的资源文件夹无需导入。若网页没有保存课程内容，请改用 PDF。</p><a className="text-button" href="https://xuanke.cufe.edu.cn/jwglxt/kbcx/xskbcx_cxXskbcxIndex.html?gnmkdm=N2151&layout=default" target="_blank" rel="noreferrer">打开教务课表<ExternalLink size={14} /></a></section></div>
